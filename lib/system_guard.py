...
ROOT = Path(__file__).resolve().parents[1]  # repo root (lib/ → padre)
...
CRITICAL_MAP = {
    "app.py": "app.py",
    "lib_bridge": "lib/neural_bridge.py",
    "lib_herramientas": "lib/herramientas.py",
    "SystemGuard": "lib/system_guard.py",
